...
<head>
    ...
    <title>Local Govt Portal Login</title>
...
<div class="page-container">
                    ...
                    <ul class="hr-menu text-right">
                        <li class="ico-menu">
                            <a href="http://www.zm4a.org" data-strwindname="egovsite" class="open-popup">
                                <img src="<cdn:url value='/resources/global/images/egov_logo_tr_h.png'/>" title="Pamodzi Technologies" height="37" alt="">
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <footer class="main">
        A product of <a href="http://www.zm4a.org" target="_blank">Pamodzi Technologies</a>
    </footer>
</div>
